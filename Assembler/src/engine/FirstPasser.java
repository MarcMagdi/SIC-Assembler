...
public class FirstPasser {
    ...
    /**.
     * Run the first pass of the algorithm. Compute the total length of the program
     * and assign location counters to every instruction and handle directives.
     * @throws InvalidFormatException if any line has an invalid format.
     */
    public void FirstPass() throws InvalidFormatException {
        ...
        // order the instruction through their entered order to add new ones added by literals.
        instructions.order();
    }

    /**.
     * Add the literal directives to the default instructions list.
     */
